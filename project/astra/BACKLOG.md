...
| TUS-005 | active | P0 | R2 | TUS-004 | project/astra/tasks/TUS-005.md | En küçük sürümlü veri ve olay sözleşmesini kur |
...
Geçerli sıra: TUS-011 tasarım kabulüyle kapandı; TUS-012 ve TUS-004 tasarım olarak kapandı; TUS-005 ilk saf çekirdek dilimi test ve ayrı incelemeden geçti; kalan kalıcılık ve oturum işleri ready. TUS-005 kapsamında kayıt adaptörü ve sentetik teknik ekran denemesi yürütülüyor; TUS-006 üretim kabulü başlamadı. Tablo satır sırası yürütme sırası değildir. v2 kapsam/bağımlılık değişiklikleri ADR-003 ve kartların tarihli eklerinde. TUS-002 gerçek karşılaştırmalı ölçüm bekler; dar tasarım çalışmasının kilidi değildir.
