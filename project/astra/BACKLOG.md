...
| TUS-012 | active | P0 | R1 | TUS-011 | project/astra/tasks/TUS-012.md | Tek oturum ekranları ve Android teslim yolu |
| TUS-013 | queued | P1 | R2 | TUS-008 | project/astra/tasks/TUS-013.md | Kabul edilmiş tek hedefi üç hedefe genişlet |

Geçerli sıra: TUS-011 tasarım kabulüyle kapandı; TUS-012 yürütülüyor. Tablo satır sırası yürütme sırası değildir. v2 kapsam/bağımlılık değişiklikleri ADR-003 ve kartların tarihli eklerinde. TUS-002 gerçek karşılaştırmalı ölçüm bekler; dar tasarım çalışmasının kilidi değildir.
